...
⚠️ **Configure your sessions if you want to work across restarts.**
The library stores callback data and wait states in the session (or in memory, if not configured),
